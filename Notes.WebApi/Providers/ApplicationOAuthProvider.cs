namespace Notes.WebApi.Providers
{
    ...
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        private readonly Func<ApplicationUserManager> applicationUserManagerFactory;

        public ApplicationOAuthProvider(string publicClientId, Func<ApplicationUserManager> applicationUserManagerFactory)
        {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var userManager = this.applicationUserManagerFactory();
